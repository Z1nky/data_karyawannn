        ...
        <div class="main-sidebar sidebar-style-2">
            ...
            <ul class="sidebar-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="active"><a class="nav-link" href="bank.php">Bank</a></li>
    ...
    <div class="main-content">
                                ...
                                <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            while($bank = mysqli_fetch_array($query)) {
                                            $i++;
                                        ?>
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            ...
                                            <td><?php echo $bank['Gaji'];?></td>
                                            <td><center><a href="#"  class="btn btn-warning" data-toggle="modal" data-backdrop="false" data-target="#modaledit<?php echo $bank['Id_Bank']; ?>" name="edit"><i class="fas fa-edit"> Edit</i></a> | 
                                                        <a href="../delete/deletebank.php?Id_Bank=<?php echo $bank['Id_Bank'];?>" class="btn btn-danger" ><i class="fas fa-trash"> Hapus</i></a></center></td>
                                        </tr>
                                        
                                        <!-- Edit  -->
                                        <div class="modal fade" data-backdrop="false" tabindex="-1" role="dialog" id="modaledit<?php echo $bank['Id_Bank']; ?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="POST" action="../edit/editbank.php">
                                                    <div class="modal-body">
                                                    <div class="card">
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Id Bank</label>
                                                                    <input type="text" class="form-control" placeholder="Id Bank" name="idbank" value="<?php echo $bank['Id_Bank']; ?>" readonly>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Nama Bank</label>
                                                                    <input type="text" class="form-control" placeholder="Nama Bank" name="namabank" value="<?php echo $bank['Nama_Bank']; ?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Kode Bank</label>
                                                                    <input type="text" class="form-control" placeholder="Kode Bank" name="kodebank" value="<?php echo $bank['Kode_Bank']; ?>">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Gajih</label>
                                                                    <input type="text" class="form-control" placeholder="Gajih" name="gajih" value="<?php echo $bank['Gaji']; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <button type="submit" class="btn btn-warning" name="ubahbank">Update</button>
                                                </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modaltambah">
            ...
            <div class="modal-content">
                ...
                <?php
                    include_once("../conf/koneksi.php");
                    $maxid = mysqli_query($db,"select max(Id_Bank) as 'idbank' from bank");
                    
                    while($result1 = mysqli_fetch_array($maxid)){
                        $idterakhir = $result1['idbank'];
                        $tambahid = $idterakhir+1;
                }

                ?>                     
                <form method="POST" action="../add/tambahbank.php">
                    <div class="modal-body">
                        <div class="card">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Id Bank</label>
                                    <input type="text" class="form-control" placeholder="Id Bank" name="idbank" value="<?php echo $tambahid?>" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Nama Bank</label>
                                    <input type="text" class="form-control" placeholder="Nama Bank" name="namabank" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Kode Bank</label>
                                    <input type="text" class="form-control" placeholder="Id Branch" name="kodebank" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Gajih</label>
                                    <input type="text" class="form-control" placeholder="Gajih" name="gajih" required>
                                </div>
                            </div>
                        </div>
                    </div>  
