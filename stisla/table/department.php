...
<body>
    ...
    <div class="main-sidebar sidebar-style-2">
        ...
        <ul class="sidebar-menu">
            ...
            <ul class="dropdown-menu">
                <li><a class="nav-link" href="karyawan.php">Karyawan</a></li>
                <li class="active"><a class="nav-link" href="department.php">Department</a></li>
...
<div class="main-content">
                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php
                                        ...
                                        $i = 0;
                                        $query = mysqli_query($db, "select * from departemen");
                                        while($department = mysqli_fetch_array($query)) {
                                        $i++;
                                    ?>
                                    <tr>
                                        <td><?php echo $i;?></td>
                                        <td><?php echo $department['Id_Departemen'];?></td>
                                        <td><?php echo $department['Kode_Departemen'];?></td>
                                        <td><?php echo $department['Nama_Departemen'];?></td>
                                        <td><?php echo $department['Alamat_Departemen'];?></td>
                                        <td><center><a href="#"  class="btn btn-warning" data-toggle="modal" data-backdrop="false" data-target="#modaledit<?php echo $department['Id_Departemen']; ?>" name="edit"><i class="fas fa-edit"> Edit</i></a> | 
                                                    <a href="../delete/deletedepartment.php?Id_Departemen=<?php echo $department['Id_Departemen'];?>" class="btn btn-danger" ><i class="fas fa-trash"> Hapus</i></a></center></td>
                                    </tr>
                                    
                                    <!-- Edit  -->
                                    <div class="modal fade" data-backdrop="false" tabindex="-1" role="dialog" id="modaledit<?php echo $department['Id_Departemen']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="../edit/editdepartment.php">
                                                <div class="modal-body">
                                                <div class="card">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label>Id Department</label>
                                                                <input type="text" class="form-control" placeholder="Id Department" name="iddepartment" value="<?php echo $department['Id_Departemen']; ?>" readonly>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label>Kode Department</label>
                                                                <input type="text" class="form-control" placeholder="Kode Department" name="kodedepartment" value="<?php echo $department['Kode_Departemen']; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label>Nama Department</label>
                                                                <input type="text" class="form-control" placeholder="Nama Department" name="namadepartment" value="<?php echo $department['Nama_Departemen']; ?>">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label>Alamat Department</label>
                                                                <input type="text" class="form-control" placeholder="Alamat Department" name="alamatdepartment" value="<?php echo $department['Alamat_Departemen']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <button type="submit" class="btn btn-warning" name="ubahdepartment">Update</button>
                                            </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modaltambah">
        ...
        <div class="modal-content">
            ...
            <?php
                include_once("../conf/koneksi.php");
                $maxid = mysqli_query($db,"select max(Id_Departemen) as 'iddepartment' from departemen");
                
                while($result1 = mysqli_fetch_array($maxid)){
                    $idterakhir = $result1['iddepartment'];
                    $tambahid = $idterakhir+1;
            }

            ?>                     
            <form method="POST" action="../add/tambahdepartment.php">
                <div class="modal-body">
                    <div class="card">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Id Department</label>
                                <input type="text" class="form-control" placeholder="Id Department" name="iddepartment" value="<?php echo $tambahid?>" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Kode Department</label>
                                <input type="text" class="form-control" placeholder="Kode Department" name="kodedepartment" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Nama Department</label>
                                <input type="text" class="form-control" placeholder="Nama Department" name="namadepartment" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Alamat Department</label>
                                <input type="text" class="form-control" placeholder="Alamat Department" name="alamatdepartment" required>
                            </div>
                        </div>
                    </div>
                </div>  
