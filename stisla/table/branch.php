        ...
        <div class="main-sidebar sidebar-style-2">
            ...
            <ul class="sidebar-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="active"><a class="nav-link" href="branch.php">Branch</a></li>
                </ul>
                </li>
            </aside>
        </div>
    ...
    <div class="main-content">
                                ...
                                <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            $i = 0;
                                            $query = mysqli_query($db, "select * from branch");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $branch['Nama_Branch'];?></td>
                                            <td><?php echo $branch['Kode_Branch'];?></td>
                                            <td><?php echo $branch['Alamat_Branch'];?></td>
                                            <td><center><a href="#"  class="btn btn-warning" data-toggle="modal" data-backdrop="false" data-target="#modaledit<?php echo $branch['Id_Branch'];?>" name="edit"><i class="fas fa-edit"> Edit</i></a> | 
                                                        <a href="../delete/deletebranch.php?Id_Branch=<?php echo $branch['Id_Branch'];?>" class="btn btn-danger" ><i class="fas fa-trash"> Hapus</i></a></center></td>
                                        </tr>
                                        
                                        <!-- Edit  -->
                                        <div class="modal fade" data-backdrop="false" tabindex="-1" role="dialog" id="modaledit<?php echo $branch['Id_Branch']; ?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="POST" action="../edit/editbranch.php">
                                                    <div class="modal-body">
                                                    <div class="card">
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Id Branch</label>
                                                                    <input type="text" class="form-control" placeholder="Id Branch" name="idbranch" value="<?php echo $branch['Id_Branch']; ?>" readonly>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Nama Branch</label>
                                                                    <input type="text" class="form-control" placeholder="Nama Branch" name="namabranch" value="<?php echo $branch['Nama_Branch']; ?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Kode Branch</label>
                                                                    <input type="text" class="form-control" placeholder="Id Branch" name="kodebranch" value="<?php echo $branch['Kode_Branch']; ?>">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Alamat Branch</label>
                                                                    <input type="text" class="form-control" placeholder="Alamat Branch" name="alamatbranch" value="<?php echo $branch['Alamat_Branch']; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <button type="submit" class="btn btn-warning" name="ubahbranch">Update</button>
                                                </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modaltambah">
            ...
            <div class="modal-content">
                ...
                <?php
                    include_once("../conf/koneksi.php");
                    $maxid = mysqli_query($db,"select max(Id_Branch) as 'idbranch' from branch");
                    
                    while($result1 = mysqli_fetch_array($maxid)){
                        $idterakhir = $result1['idbranch'];
                        $tambahid = $idterakhir+1;
                }

                ?>                     
                <form method="POST" action="../add/tambahbranch.php">
                    <div class="modal-body">
                        <div class="card">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Id Branch</label>
                                    <input type="text" class="form-control" placeholder="Id Branch" name="idbranch" value="<?php echo $tambahid?>" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Nama Branch</label>
                                    <input type="text" class="form-control" placeholder="Nama Branch" name="namabranch" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Kode Branch</label>
                                    <input type="text" class="form-control" placeholder="Kode Branch" name="kodebranch" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Alamat Branch</label>
                                    <input type="text" class="form-control" placeholder="Alamat Branch" name="alamatbranch" required>
                                </div>
                            </div>
                        </div>
                    </div>  
